...
export default function About() {
  return (
    <section className="dgm-about-area pt-120 pb-120">
          ...
          <div className="col-lg-6">
            <div className="dgm-about-thumb-wrap p-relative">
              <img
                ...
                data-delay=".3"
                data-fade-from="left"
                src="/assets/img/home-03/about/about-1.png"
                alt="About main"
              />
              <img
                ...
                data-speed="1.1"
                data-delay=".5"
                src="/assets/img/home-03/about/about-2.png"
                alt="About secondary"
              />
            </div>
          </div>
          <div className="col-lg-6">
            <div className="dgm-about-right">
              <div className="dgm-about-title-box z-index-1 mb-35">
                <span className="tp-section-subtitle subtitle-black mb-15 tp_fade_anim" data-delay=".3">
                  Sobre nosotros
                </span>
              ...
              <div className="dgm-about-content">
                <div className="tp_fade_anim" data-delay=".3">
                  <p>
                    Somos una consultora tecnológica que ayuda a startups y empresas a transformar sus ideas en productos digitales reales.
                    Creamos MVPs rápidos y escalables, validamos modelos de negocio y diseñamos automatizaciones que eliminan tareas repetitivas, ahorrando tiempo y recursos. <br /><br />
                    Con nuestra experiencia, combinamos estrategia + software para que tu empresa crezca más rápido y con menos riesgos.
                  </p>
                </div>
                <div className="tp_fade_anim" data-delay=".5">
                  <a
                    className="tp-btn-yellow-green green-solid btn-60 mb-50"
                    href="https://wa.me/573112530069?text=Hola%20Quisiera%20saber%20m%C3%A1s%20sobre%20las%20automatizaciones"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <span>
                      <span className="text-1">Conócenos mejor</span>
                      <span className="text-2">Conócenos mejor</span>
                    </span>
                    <i>
                ...
                <div className="dgm-about-review-wrap tp_fade_anim" data-delay=".6">
                  <div className="dgm-about-review-box d-inline-flex align-items-center">
                    <div className="dgm-about-review">
                      <h4>4.9</h4>
                      <span>( Clientes destacan nuestra velocidad y calidad en entregas )</span>
                    </div>
